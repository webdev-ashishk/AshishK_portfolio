    ...
    <section className="py-10">
      <div className="flex justify-between items-center gap-8 flex-col lg:flex-row mt-10">
        ...
        <div className="max-w-2xl">
          ...
          <p className="mb-2">
            I am a fast learner with a strong passion for front-end development
            and a focus on creating efficient and user-friendly web
            applications. I am seeking an opportunity to work in a collaborative
            environment where I can further enhance my skills and contribute to
            meaningful projects.
          </p>
          <p>
            I am open to internships, entry-level positions, or any opportunity
            that allows me to grow as a React developer. I am a dedicated team
            player, eager to learn from experienced professionals and contribute
            to the success of the organization.
          </p>
          <p>
            If you have an opportunity that aligns with my skills and passion, I
            would be thrilled to discuss how I can contribute to your team.
